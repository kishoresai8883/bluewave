  ...
  const testimonials = [
    {
      ...
      content: 'GeoExcel delivered exceptional GIS mapping services for our urban development project. Their attention to detail and technical expertise were instrumental in our success. We particularly appreciated their ability to translate complex spatial data into accessible visualizations that informed our decision-making process.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'We\'ve been working with GeoExcel for over 3 years for our technical staffing needs. They consistently provide qualified professionals who integrate seamlessly with our team. Their understanding of our specific technical requirements ensures we get candidates with the exact skill sets we need.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Their spatial analysis capabilities helped us identify optimal locations for our new facilities. GeoExcel\'s insights saved us both time and resources in our expansion. The team was responsive and worked closely with us to ensure our specific requirements were met throughout the project.',
      rating: 4,
    ...
    },
    {
      ...
      company: 'TeleMap Networks',
      content: 'The GIS solutions provided by GeoExcel revolutionized how we manage our telecommunications infrastructure. Their custom mapping tools have become an essential part of our daily operations, improving efficiency and reducing response times to service issues.',
      rating: 5,
    ...
    },
    {
      ...
      company: 'EcoSpatial Research',
      content: 'GeoExcel\'s remote sensing expertise was crucial for our environmental monitoring project. Their ability to process and analyze satellite imagery provided us with critical data on land use changes that formed the foundation of our research findings.',
      rating: 4,
    ...
    },
    {
      ...
      company: 'UrbanInfra Solutions',
      content: 'The technical staff provided by GeoExcel were exceptional. Their expertise in GIS and infrastructure mapping helped us complete our city-wide project ahead of schedule. We particularly appreciated their proactive approach to problem-solving and their commitment to quality.',
      rating: 5,
